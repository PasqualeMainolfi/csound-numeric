...
- **csnwhere** - picks from two arrays element by element, driven by a mask (i, k — real only)
...
- **csnbincount** - counts every non-negative integer bin, optionally accumulating weights (i, k — real only)
- **csnsearchsorted** - insertion indices in an ascending 1-D array, left or right of equal values (i, k — real only)
...
- **csnminimum** - elementwise minimum of two arrays, or of an array and a scalar (i, k — real only)
- **csnmaximum** - elementwise maximum of two arrays, or of an array and a scalar (i, k — real only)
...
- **csnatan2** - two-argument arctangent, quadrant aware (i, k — real only)
...
- **csnisnan** - 1 where an element is NaN, otherwise 0 (i, k — real only)
- **csnisinf** - 1 where an element is positive or negative infinity, otherwise 0 (i, k — real only)
- **csnisfin** - 1 where an element is finite, otherwise 0 (i, k — real only)
...
- **csnrms** - root mean square, over everything or along an axis (i, k — real only)
