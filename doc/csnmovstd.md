...
handle:CsnArr = csnmovstd(source:CsnArr, winsize:k, trig:k)
handle:CsnArr = csnmovstd(source:CsnArr, winsize:k, trig:k, axis:k)
csnmovstd(source:CsnArr, winsize:i)
csnmovstd(source:CsnArr, winsize:i, axis:i)
csnmovstd(source:CsnArr, winsize:k, trig:k)
csnmovstd(source:CsnArr, winsize:k, trig:k, axis:k)
```
