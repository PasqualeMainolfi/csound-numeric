...
handle:CsnArr = csnmovvar(source:CsnArr, winsize:k, trig:k)
handle:CsnArr = csnmovvar(source:CsnArr, winsize:k, trig:k, axis:k)
csnmovvar(source:CsnArr, winsize:i)
csnmovvar(source:CsnArr, winsize:i, axis:i)
csnmovvar(source:CsnArr, winsize:k, trig:k)
csnmovvar(source:CsnArr, winsize:k, trig:k, axis:k)
```
